...
namespace Lexical.FileProvider.Common
{
    ...
    public interface IDisposeList : IDisposable
    {
        ...
        bool AddDisposable(IDisposable disposable);
        ...
        bool AddDisposables(IEnumerable<IDisposable> disposables);
        ...
        /// <param name="disposables"></param>
        /// <returns>true if was removed, false if it wasn't in the list.</returns>
        bool RemoveDisposables(IEnumerable<IDisposable> disposables);
    }
